...
class _$NewsDao extends NewsDao {
  _$NewsDao(
    ...
    this.changeListener,
        ...
        _newsModelDeletionAdapter = DeletionAdapter(
            database,
            'news',
            ['id'],
            (NewsModel item) => <String, Object?>{
  ...
  final DeletionAdapter<NewsModel> _newsModelDeletionAdapter;
  ...
  Future<void> insertNews(NewsModel news) async {
    await _newsModelInsertionAdapter.insert(news, OnConflictStrategy.abort);
  }

  @override
  Future<void> deleteNews(NewsModel NewsModel) async {
    await _newsModelDeletionAdapter.delete(NewsModel);
  }
}
